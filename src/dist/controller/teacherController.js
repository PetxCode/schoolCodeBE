...
const getSchoolTeacherInfoForClasses = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const teachers = yield teacherModel_1.default.findById(req.params.id).populate({
            path: "myClass",
            options: {
                sort: {
                    createdAt: -1,
...
exports.getSchoolTeacherInfoForClasses = getSchoolTeacherInfoForClasses;
const updateTeacher = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const user = yield teacherModel_1.default.findByIdAndUpdate(req.params.id, { image: image.secure_url }, { new: true });
        return res.status(200).json({
...
const updateTeacherInfo = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { address, contact, bio, motivation } = req.body;
        const user = yield teacherModel_1.default.findByIdAndUpdate(req.params.id, { address, contact, bio, motivation }, { new: true });
        return res.status(200).json({
