...
router.route("/:id/:studentID/present").post(attendanceController_1.createAttendancePresent);
router.route("/:id/:studentID/absent").post(attendanceController_1.createAttendanceAbsent);
router
